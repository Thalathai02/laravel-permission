...
@section('content')
    ...
    <body>
        ...
        <div class="container">
            ...
            @endif
            <h3 class="my-4">จากคณะกรรมการชุดเดิม </h3>
            ...
            @endif
            <h3 class="my-4">เป็นคณะกรรมการชุดใหม่ </h3>
        ...
        <div class="my-2">
            ...
            {!! Form::open(['action' => ['projectControllers@reject_project',$id_Notifications,$datas[0]->id,4], 'method' => 'POST']) !!}
            <!-- Modal -->
