...
@section('content')
    ...
    'class' => 'form-control
            ...
            <div class="my4">
                ...
                {!! Form::text('date_test50', formatDateThai($tableTest50_id->date_test50), ['readonly', 'class' => 'form-control col-5']) !!}

            </div>
            <div class="my4">
                {!! Form::label('date_test50', 'เวลา ') !!}
                {!! Form::text('date_test50', formatDateThai_time($tableTest50_id->date_test50), ['readonly', 'class' => 'form-control col-5']) !!}
            ...
            <div class="my-4">
                ...
                <a href="{!! route('InfoWordTemplate.download', ['form' => 'test50', 'status' => $tableTest50_id->status_test50, 'file' => $tableTest50_id->file_test50]) !!}" download>ดาวน์โหลดเอกสาร</a>
            </div>
            ...
            <div class="my-2">
                ...
                @if (Auth::user()->reg_tea_id == $datas_instructor[0]->id || Auth::user()->id == 1 )
