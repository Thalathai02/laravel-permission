                ...
                <div class="row">
                    ...
                    <div class="col-xl-3 col-lg-3">
                        ...
                        <script>
                            ...
                            var output1 = document.getElementById("output_point_reg_std2");
            ...
            <div class="row">
                ...
                <div class="col-xl-3 col-lg-3">
                    ...
                    <script>
                        ...
                        var output2 = document.getElementById("output_point_reg_std3");
    ...
    <div class="container">
        ...
        <div class="my-2 row-1">
            ...
            <div class="row">
                ...
                <div class="col-xl-3 col-lg-3">
                    {!! Form::range('point_reg_std1', $point_test100[0]->point_test100 ,['class' => 'form-range ']) !!}
                    <div id="output_point_reg_std1"></div>
                    <script>
                        var slider = document.getElementById("point_reg_std1");
                        var output = document.getElementById("output_point_reg_std1");
        ...
        @if (!empty($datas_std[1]->name))
            <div class="my-4">
                ...
                <div class="row">
                    ...
                    <div class="col-xl-3 col-lg-3">
                        {!! Form::range('point_reg_std2', $point_test100[1]->point_test100, ['class' => 'form-range ']) !!}
                        <div id="output_point_reg_std2"></div>
                        <script>
                            var slider = document.getElementById("point_reg_std2");
                            var output1 = document.getElementById("output_point_reg_std2");
        ...
        <div class="my-4">
            ...
            <div class="row">
                ...
                <div class="col-xl-3 col-lg-3">
                    {!! Form::range('point_reg_std3', $point_test100[2]->point_test100 , ['class' => 'form-range ']) !!}
                    <div id="output_point_reg_std3"></div>
                    <script>
                        var slider = document.getElementById("point_reg_std3");
                        var output2 = document.getElementById("output_point_reg_std3");
